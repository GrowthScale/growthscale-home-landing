        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-6 bg-card rounded-xl shadow-lg border border-border">
              ...
              <p className="text-muted-foreground">API REST completa com documentação detalhada</p>
            </div>
            ...
            <div className="text-center p-6 bg-card rounded-xl shadow-lg border border-border">
              ...
              <h3 className="text-xl font-bold text-foreground mb-2">Webhooks</h3>
            ...
            <div className="text-center p-6 bg-card rounded-xl shadow-lg border border-border">
              ...
              <p className="text-muted-foreground">Autenticação OAuth2 e rate limiting</p>
            </div>
          </div>

          {/* Code Example */}
          <div className="max-w-4xl mx-auto mb-16">
            <div className="bg-background-dark rounded-2xl p-8">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold text-foreground-dark">Exemplo de Integração</h3>
                <Button variant="outline" size="sm" className="text-foreground-dark border-foreground-dark hover:bg-foreground-dark hover:text-background-dark">
                  <BookOpen className="h-4 w-4 mr-2" />
                  Ver Documentação
                </Button>
              </div>
              <pre className="text-accent text-sm overflow-x-auto">
