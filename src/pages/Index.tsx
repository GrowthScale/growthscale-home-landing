    ...
    <div className="container flex h-16 items-center">
      <div className="mr-4 flex">
        <Link to="/" className="flex items-center space-x-2">
          {/* ANOTAÇÃO: Adicione o seu logo SVG aqui (versão branca/monocromática) */}
          <svg className="h-6 w-6 text-foreground" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path></svg>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          <Button asChild size="lg" className="text-lg px-8 py-6">
            <Link to="/auth">Comece a Simplificar Agora</Link>
          </Button>
...
// --- COMPONENTE DA SECÇÃO DE PROVA SOCIAL ---
const SocialProofSection = () => (
    <section className="py-20 bg-background">
        <div className="container mx-auto px-4 text-center">
            <p className="text-muted-foreground mb-8">A ferramenta de confiança para gestores de restaurantes que valorizam o seu tempo e a sua tranquilidade</p>
...
// --- COMPONENTE DA SECÇÃO DE NARRATIVA (DOR + SOLUÇÃO) ---
    ...
    <div className="container mx-auto px-4 space-y-24">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-muted-foreground">Enquanto você arrasta e solta, a nossa IA audita cada turno, alertando-o para potenciais riscos de intervalos e excesso de jornada. Opere com a clareza de quem sabe que está a tomar decisões informadas.</p>
        </div>
        <div className="rounded-xl p-2 bg-background/10 border border-border/20 shadow-lg">
          {/* ANOTAÇÃO: TODO: GIF do alerta de risco em modo escuro. */}
          <img src="/placeholder-gif-1-dark.png" alt="Demonstração do alerta de compliance" className="rounded-lg" />
        </div>
      </div>
      
      {/* Bloco 3: O Poder da IA (Eficiência) */}
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="rounded-xl p-2 bg-background/10 border border-border/20 shadow-lg md:order-last">
          {/* ANOTAÇÃO: TODO: GIF da sugestão de IA em modo escuro. */}
        ...
        <div>
          ...
          <p className="text-muted-foreground">O que levava horas, agora leva segundos. Use os nossos modelos pré-definidos ou deixe a IA criar a escala otimizada com um clique. Mais tempo para si, para a sua equipa e para os seus clientes.</p>
        </div>
      </div>
    </div>
  </section>
...
// --- COMPONENTE DA SECÇÃO DE PLANOS ---
