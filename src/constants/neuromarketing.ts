...
// Copy específico para cada seção da landing page
export const landingPageCopy = {
  hero: {
    h1: "Crie escalas perfeitas em minutos e fique 100% dentro da lei",
    subtitle: "A plataforma com Inteligência Artificial que blinda seu restaurante, otimiza suas escalas e te dá controle total dos custos. Sem planilhas, sem medo.",
    ctaPrimary: "Gerar minha escala agora",
    ctaSecondary: "Ver demo de 3 minutos",
    trustBadge: "500+ restaurantes já economizam R$2.500/mês",
  },

  benefits: {
    title: "Por que restaurantes escolhem o GrowthScale?",
    subtitle: "Resultados comprovados que transformam a gestão do seu negócio",
    items: [
      {
        title: "Economia Garantida",
        description: "Reduza custos operacionais em até 30% com escalas otimizadas",
        value: "R$2.500/mês",
        icon: "💰",
      },
      {
        title: "Tempo Livre",
        description: "Economize 8 horas por semana na gestão de escalas",
        value: "8h/semana",
        icon: "⏰",
      },
      {
        title: "Segurança Jurídica",
        description: "Fique 100% em conformidade com a CLT automaticamente",
        value: "100%",
        icon: "🛡️",
      },
      {
        title: "Produtividade",
        description: "Aumente a eficiência da sua equipe em 40%",
        value: "40%",
        icon: "📈",
      },
    ],
  ...
  socialProof: {
    title: "Restaurantes que já transformaram sua gestão",
    subtitle: "Veja o que nossos clientes dizem sobre o GrowthScale",
    testimonials: [
      {
        name: "João Silva",
        restaurant: "Restaurante Sabor & Arte",
        text: "O GrowthScale salvou meu negócio. Economizei R$3.200 no primeiro mês e agora durmo tranquilo.",
        rating: 5,
        savings: "R$3.200/mês",
      },
      {
