...
export const landingPageCopy = {
  hero: {
    h1: "🚨 Pare de perder R$2.500/mês com escalas desorganizadas",
    subtitle: "A IA que já salvou 500+ restaurantes de multas trabalhistas. Crie escalas perfeitas em 3 minutos e durma tranquilo sabendo que está 100% dentro da lei.",
    ctaPrimary: "🚀 Começar a economizar AGORA",
    ctaSecondary: "👀 Ver como funciona (3 min)",
