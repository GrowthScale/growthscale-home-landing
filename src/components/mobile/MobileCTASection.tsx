  ...
  return (
    <section className="py-16 bg-gradient-to-br from-blue-600 to-blue-700 text-white">
      <div className="container mx-auto px-4 text-center">
        {/* Urgency Banner */}
        <div className="mb-8">
          <div className="bg-destructive text-white px-4 py-3 rounded-lg animate-pulse">
        ...
        <div className="mb-8">
          ...
          <Button 
            size="lg" 
            className="w-full sm:w-auto text-lg px-8 py-6 bg-white text-primary hover:bg-muted font-semibold shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 min-h-[56px] animate-pulse"
        ...
        {/* Oferta Limitada */}
        <div className="bg-destructive/20 border border-red-400/30 rounded-lg p-4 mb-8">
          <div className="flex items-center justify-center gap-2 mb-2">
            <Zap className="w-5 h-5 text-destructive" />
            <h3 className="text-sm font-bold text-destructive">Oferta Limitada</h3>
          </div>
        ...
        <div className="mt-8">
          <Button 
            variant="outline" 
            size="lg" 
            className="w-full sm:w-auto text-base px-6 py-4 border-white/30 text-white hover:bg-white hover:text-primary transition-all duration-300 min-h-[48px]"
                          onClick={() => {
