...
import { AlertTriangle, DollarSign, Clock, Users, FileText, TrendingDown, Zap, Shield } from 'lucide-react';
  ...
  const problems = [
    {
      ...
      description: "Multas trabalhistas e horas extras desnecessárias que destroem sua margem de lucro",
    ...
    },
    {
      ...
      description: "Tempo gasto criando e ajustando escalas manualmente que poderia ser usado para crescer",
    ...
    {
      icon: AlertTriangle,
      title: "⚖️ Risco de multas CLT",
      description: "Violações trabalhistas que podem custar milhares e até fechar seu negócio",
    ...
    },
    {
      ...
      description: "Escalas injustas e comunicação ineficiente que geram turnover alto",
    ...
    },
    {
      ...
      description: "Planilhas complexas e propensas a erros que comprometem a eficiência",
    ...
    },
    {
      ...
      description: "Equipe desmotivada e processos desorganizados que afetam resultados",
            ...
            >
              ...
              <div className="mt-4 flex items-center justify-between">
                <span className={`px-3 py-1 rounded-full text-xs font-bold ${
                  problem.urgency === 'CRÍTICO' ? 'bg-red-100 text-red-700' :
                  problem.urgency === 'ALTO' ? 'bg-orange-100 text-orange-700' :
