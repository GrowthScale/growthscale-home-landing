  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center text-center overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
        ...
        <p className="text-lg sm:text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
          <Button 
            size="lg" 
            className="bg-primary hover:bg-primary/90 text-primary-foreground text-lg sm:text-xl px-8 sm:px-10 py-6 sm:py-7 font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
          >
          ...
          <Button 
            size="lg" 
            variant="outline" 
            className="text-lg sm:text-xl px-8 sm:px-10 py-6 sm:py-7 border-2 border-white text-white hover:bg-white hover:text-slate-900 font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
          >
