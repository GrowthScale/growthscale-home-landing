-- =====================================================
-- SCHEMA COMPLETO DO BANCO DE DADOS - GROWTHSCALE
-- =====================================================
...
-- =====================================================
-- 2. TABELA COMPANY_USERS (Relacionamento User-Company)
-- =====================================================
...
CREATE TABLE employees (
  ...
  branch_id UUID -- Referência para branches (será criada depois)
);
...
-- Adicionar foreign key em employees para branches
...
-- Inserir empresa de exemplo (opcional)
-- INSERT INTO companies (name, cnpj, trade_name, status, address, contact, settings) 
-- VALUES (
--   'GrowthScale Demo',
--   '12.345.678/0001-90',
--   'GrowthScale',
--   'active',
--   '{"street": "Rua Exemplo", "city": "São Paulo", "state": "SP", "zipCode": "01234-567"}',
--   '{"email": "contato@growthscale.com", "phone": "(11) 99999-9999"}',
